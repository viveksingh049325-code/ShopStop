<div align="center">
  <img src="https://cdn-icons-png.flaticon.com/512/3514/3514491.png" alt="ShopStop Logo" width="80" />
  <h1>ShopStop - Full-Stack MERN E-Commerce App</h1>
...
MONGO_URI=mongodb://127.0.0.1:27017/ShopStop
JWT_SECRET=super_secret_key
RAZORPAY_KEY_ID=your_key_id
RAZORPAY_KEY_SECRET=your_key_secret
```

From the **root folder** `ShopStop/`, trigger a full install across environments:
```bash
npm run build
```
...
npm run seed
```
> **Seed Admin Access:** Email: `admin@ShopStop.com` | Password: `password123`
...
This repository includes a fully-scaffolded API testing toolkit: **`ShopStop_Postman_Collection.json`**. 
